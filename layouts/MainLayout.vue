  ...
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="w-full bg[#FAFAFA] border-b md:block hidden">
      <ul class="flex items-center justify-end text-xs text-[#333333] font-light px-2 h-10 bg-[#FAFAFA] max-w-[1200px]">
        ...
        <li class="px-3 hover:text-[#FF4646] cursor-poiner">
          <Icon name="ic:sharp-install-mobile" size="17" />
          App
        </li>

        <li @mouseenter="isAccountMenu = true" @mouseleave="isAccountMenu = false"
          class="relative flex items-center px-2.5 hover:text-[#FF4646] h-full cursor-pointer" :class="
            isAccountMenu
          ...
          <div id="AccountMenu" v-if="isAccountMenu"
            ...
            <div class="border-b" />
            <ul class="bg-white">
              <li @click="navegateTo('/orders')" class="text-[13px] py-2 px-4 w-full hover:bg-gray-200">
                My Orders
              </li>
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div class="flex lg:jusfy-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            ...
            <div class="absolute bg-white max-white max-w-[700px] h-auto w-full">
              <div v-if="false" class="p-1">
                <NuxtLink to="`/item/1`"
                  class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-100">
                  <div class="flex items-center">
                    <img class="rounded-md" width="40" src="/cart-empty.png" alt="" />
                    <div class="trubcate ml-2">TESTING</div>
                  </div>
