<template>
  <div id="MainLayout" class="w-full fixed z-50">
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div
        class="flex lg:jusfy-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto"
      >
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            ...
            <div
              class="absolute bg-white max-white max-w-[700px] h-auto w-full"
            >
